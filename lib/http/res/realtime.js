...
var realtime = function () {
	var realtime = angular.module("danmu.realtime", ["ui.bootstrap", "realtimeControllers"]);
	...
	realtime.config(['$httpProvider', function ($httpProvider) {
	...
	realtimeControllers.controller("MainCtrl", function ($scope, $http, $rootScope) {
		$scope.accordion = {
			openInfo: true
		};
		$scope.isLogin = false;
